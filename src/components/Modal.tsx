      ...
      <Dialog as="div" className="relative z-50" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className={`w-full max-w-md transform overflow-hidden rounded-lg bg-neutral-800 p-6 md:p-8 text-left align-middle shadow-xl transition-all ${className}`}>
                <button
                  type="button"
