...
export interface SalesAssetProps {
...
interface DataProps {
  data: SalesAssetProps[];
}


export async function getSalesInventoryService(
  chainKey,
  options
  ...
  //console.log('info in options:', options);
  //console.log('info in params:', params);
  return response;
}
